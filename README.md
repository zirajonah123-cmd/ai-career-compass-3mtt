...
ML pipeline
Combine learner profile fields into text.
Convert text into TF-IDF features.
Classify the profile with multiclass Logistic Regression.
Return the top three ranked career classes.
Provide a human-readable learning roadmap.
Technology
Python
pandas
scikit-learn
